...
body[baidu] .c-container h3{
    background-color: rgba(248,248,248, 0.3) !important; /*百度搜索块体 - 标题的颜色；透明度=0.1，最大1*/
        ...
        let AllData = {
            ...
            lan: {
                ...
                zh_cn: {
                    ...
                    curLang: "zh_cn",
                    fieldset_panel: {
                        panel_title: " " + (inExtMode ? 'Ext' : ''),
                        setting_panel: {
                            redirect_text: "主功能-重定向",
                            redirect_title: "重定向的开启与否",
                            ads_text: "去广告",
                            ads_title: " ",

                            userStyle_baidu_lable: "百度>>",
                            userStyle_baidu_1line_enter: "单列居中",
                            userStyle_baidu_2line: "双列",

                            userStyle_google_lable: "谷歌>>",
                            userStyle_google_1line_enter: "单列居中",
                            userStyle_google_2line: "双列",



                            searchOrigin_text: "移除百度搜索预测",
        ...
        Promise.all([GM.getValue("Config")]).then(function(data) {
            ...
            AllData.lan.use = AllData.lan.zh_cn;
            // 初始化完成之后才能调用正常函数
            callback();
